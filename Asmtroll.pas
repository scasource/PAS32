...
type
  TAssessmentRollForm = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    ...
    Label4: TLabel;
    CollectionTypeLookup: TComboBox;
    ...
    PrintCoopTotalsCheckBox: TCheckBox;
    PrintToExcelCheckBox: TCheckBox;
    PrintZoningCodeCheckBox: TCheckBox;
    PrintAdditionalLotsCheckBox: TCheckBox;
    PrintPermitsCheckBox: TCheckBox;
    UseNassauPrintKeyFormatCheckBox: TCheckBox;
    PrintHistoryRollCheckBox: TCheckBox;
...
{========================================================}
Procedure TAssessmentRollForm.FormActivate(Sender: TObject);
...
{========================================================}
Procedure TAssessmentRollForm.InitializeForm;
...
{==================================================================}
Procedure TAssessmentRollForm.PrinterComboBoxChange(Sender: TObject);
...
{==================================================================}
Procedure TAssessmentRollForm.CollectionTypeLookupChange(Sender: TObject);
...
{==================================================================}
Procedure TAssessmentRollForm.LoadSDRateList(    SDRateList : TList;
                                                 SelectedRollSections : TStringList;
                                             var Quit : Boolean);
...
{===============   FILL THE SORT FILES ============================}
{===================================================================}
Function TAssessmentRollForm.ParcelToBeBilled(    ParcelTable : TTable;
                                                  RollSectionsSelected : TStringList;
                                              var NumInactive : LongInt) : Boolean;
...
{===================================================================}
Procedure TAssessmentRollForm.SaveEXTaxTotals(ExemptionCodes,
                                              ExemptionHomesteadCodes,
                                              CountyExemptionAmounts,
                                              TownExemptionAmounts,
                                              SchoolExemptionAmounts,
...
var
  ...
  _SchoolCode : String;
  Amount1, Amount2, Amount3, Amount4 : Comp;
  ...
  For I := 0 to (ExemptionCodes.Count - 1) do
    begin
      ...
      If (CollectionType = 'MU')
        then
          begin
            ...
            Amount4 := StrToFloat(VillageExemptionAmounts[I]);
          end;
      ...
      If (CollectionType = 'VI')
        then Amount4 := StrToFloat(VillageExemptionAmounts[I]);
...
{===================================================================}
Procedure TAssessmentRollForm.SaveGenTaxTotals(LandAssessedVal,
                                               TotalAssessedVal,
                                               _TaxableVal,
                                               ExemptionAmount,
                                               BasicSTARAmount,
...
{===================================================================}
Procedure TAssessmentRollForm.InsertGeneralTaxRecord(    ParcelTable : TTable;
                                                         TaxRollYr : String;
                                                         GeneralRateRec : GeneralRateRecord;
                                                         HomesteadCode : String;
                                                         EXTotArray : ExemptionTotalsArrayType;
...
{===================================================================}
Procedure TAssessmentRollForm.SaveSchTaxTotals(LandAssessedVal,
                                               TotalAssessedVal,
                                               ExemptionAmount,
                                               BasicSTARAmount,
                                               EnhancedSTARAmount : Comp;
...
{===================================================================}
Function TAssessmentRollForm.ConvertSDValue(     ExtCode : String;
                                                 SDValue : String;
                                                 ExtCatList : Tlist;
                                             var ExtCategory : String) : Double;
...
{===================================================================}
Procedure TAssessmentRollForm.GetSDValues(    SDExtCategory : String;
                                              SDExtension : String;
                                              HomesteadCode : String;
                                              HstdLandVal,
                                              NonhstdLandVal,
...
{===================================================================}
Procedure TAssessmentRollForm.SaveSDistTaxTotals(ExtCode : String;
                                                 TaxableValAmount : Double;
                                                 _HomesteadCode : String;
                                                 SDExtCategory: String;
                                                 HstdLandVal,
...
{===================================================================}
Procedure TAssessmentRollForm.SaveInfoThisParcel(     CollectionType : String;
                                                      GeneralRateList,
                                                      SDRateList,
                                                      SDExtCategoryList,
                                                      GeneralTotalsList,
...
{===================================================================}
Procedure TAssessmentRollForm.SaveBillingTotals(    GeneralTotalsList,
                                                    SDTotalsList,
                                                    SchoolTotalsList,
                                                    EXTotalsList : TList;
                                                var Quit : Boolean);
...
{===================================================================}
Procedure TAssessmentRollForm.SortFiles(    GeneralRateList,
                                            SDRateList,
                                            SDExtCategoryList : TList;
                                            ParcelTable : TTable;
                                            TaxRollYear : String;
...
{=====================================================================}
Procedure TAssessmentRollForm.PrintButtonClick(Sender: TObject);
    ...
    then
      ...
      with BLHeaderTaxTable do
        case IndexRadioGroup.ItemIndex of
          ...
          3 : IndexName := 'BYSCHOOL_SWIS_RS_AccountNumber';
          else
            begin
...
(*        If (CollectionTypeLookup.Text = 'Municipal')
    ...
    then
      begin
        ...
        PrintHistoryAssessmentRoll := PrintHistoryRollCheckBox.Checked;
          ...
          {FXX11292010(2.26.1.21)[I8380]: Allow for history printing no matter the year that they want.}
        ...
        If (*((RollPrintingYear <> GlblThisYear) and
          ...
          then
            begin
              ...
              If _Compare(TaxRollYear, GlblNextYear, coEqual)
              then ProcessingType := NextYear
              else
                If _Compare(TaxRollYear, GlblThisYear, coEqual)
                then ProcessingType := ThisYear
                else ProcessingType := History;
  ...
  If (OKToStartPrinting and
      (not PrintHistoryAssessmentRoll))
  ...
  If (OKToStartPrinting and
      (not PrintHistoryAssessmentRoll) and
    ...
    then
      ...
      (*                          ReportFiler.SectionLeft := 1.5;*)
        ...
        If ((RollType = 'T') and
            (not PrintHistoryAssessmentRoll))
          then
            If (MessageDlg('Do you wish to create the roll for NYS ORPS now?', mtConfirmation, [mbYes, mbNo], 0) = idYes)
              then
                begin
                  IncludeInventory := (MessageDlg('Do you wish to include parcel inventory in the extract?',
                                                  mtConfirmation, [mbYes, mbNo], 0) = idYes);

                  Generate995File(Self, SelectedSwisCodes, SelectedRollSections,
                                  GlblDrive + ':' + GlblExportDir + 'RPS060I1',
                                  GlblDrive + ':' + GlblExportDir + 'RPS995T1',
                  ...
                  If (MessageDlg('Do you want to email this file?' + #13 +
                    ...
                    then
                      begin
                        ...
                        EMailFile(Self, ExtractDir, ExtractDir, ZipFileName, emlORPSExtract, '', MailSubject,
                                  '', SelectedFiles, True);
                        SelectedFiles.Free;
          ...
          {FXX06102010-2(2.26.1)[I7566]: The free of the selected roll sections was causing a GPF because it was too early.}
...
{===================================================================}
Function TAssessmentRollForm.ParcelShouldBePrinted : Boolean;
...
{===================================================================}
Procedure TAssessmentRollForm.AddRecordToExtractFile(var ExtractFile : TextFile;
                                                         BLHeaderTaxTable : TTable;
                                                         GnTaxList,
                                                         ExTaxList,
                                                         SDTaxList : TList);
...
{=====================  PRINTING LOGIC  ============================}
{===================================================================}
Procedure TAssessmentRollForm.TextFilerBeforePrint(Sender: TObject);
...
{===============================================================}
Procedure TAssessmentRollForm.TextFilerPrint(Sender: TObject);

var
  ParcelSubheaderPrinted,
  FirstTimeThrough,
  ParcelPrintedThisPage,  {Has a parcel been printed on this page?}
  TotalsPrinted, Quit, DoneWithReport, bPrintParcel : Boolean;
  SwisSBLKey : String;
...
begin
  ...
  case IndexRadioGroup.ItemIndex of
    ...
    3: SequenceStr := 'ACCOUNT NUMBER ORDER';
  end;  {case IndexRadioGroup.ItemIndex of}
      ...
      repeat
        ...
        If FirstTimeThrough
          then FirstTimeThrough := False
            ...
            try
              BLHeaderTaxTable.Next;
            except
              SystemSupport(056, BLHeaderTaxTable, 'Error getting next Tax Record.',
                            UnitName, GlblErrorDlgBox);
            end;
          ...
          then
            with BLHeaderTaxTable do
              case IndexRadioGroup.ItemIndex of
                ...
                2 : ProgressDialog.Update(Self, FieldByName('LegalAddr').Text);
        ...
        bPrintParcel := (not (DoneWithReport or TotalsOnly));

        If (bPrintParcel and
            PrintHistoryAssessmentRoll and
            LoadFromParcelList and
            (not ParcelListDialog.ParcelExistsInList(SwisSBLKey)))
        then bPrintParcel := False;
...
{=========================================================================}
Procedure TAssessmentRollForm.ReportPrint(Sender: TObject);
...
{===============================================================}
Procedure TAssessmentRollForm.CloseButtonClick(Sender: TObject);
...
{===================================================================}
Procedure TAssessmentRollForm.FormClose(    Sender: TObject;
