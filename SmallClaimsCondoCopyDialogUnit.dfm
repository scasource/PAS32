object SmallClaimsCondoCopyDialog: TSmallClaimsCondoCopyDialog
  Left = 489
  Top = 396
  Width = 332
  Height = 462
  ...
  object InformationLabel: TLabel
    ...
    AutoSize = False
    Caption = 
      'Please enter the additional parcels that should have a small cla' +
      'ims created ...'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlue
    Font.Height = -13
  ...
  object SmallClaimsExemptionsAskedTable: TwwTable
    DatabaseName = 'PASsystem'
  ...
  object SmallClaimsLookupTable: TTable
    DatabaseName = 'PASsystem'
    IndexName = 'BYTAXROLLYR_SWISSBLKEY_INDEXNUM'
    TableName = 'GSmallClaimsTable'
    TableType = ttDBase
  ...
  object SmallClaimsExemptionsAskedLookupTable: TTable
    DatabaseName = 'PASsystem'
    IndexName = 'BYYEAR_SBL_INDEXNUM_EX'
    TableName = 'gscexemptionsasked'
    TableType = ttDBase
