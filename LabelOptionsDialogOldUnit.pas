unit LabelOptionsDialogOldUnit;
...
type
  TLabelOptionsDialogOld = class(TForm)
    OKButton: TBitBtn;
...
var
  LabelOptionsDialogOld: TLabelOptionsDialogOld;

implementation

{$R *.DFM}

uses GlblCnst, DataModule, PASUtils;

{===========================================================}
Procedure TLabelOptionsDialogOld.FormCreate(Sender: TObject);
...
{===========================================================}
Procedure TLabelOptionsDialogOld.PrintParcelIDOnlyCheckBoxClick(Sender: TObject);
...
{===========================================================}
Procedure TLabelOptionsDialogOld.OKButtonClick(Sender: TObject);
