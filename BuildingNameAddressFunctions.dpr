library BuildingNameAddressFunctions;
...
begin
  ...
  Result := OpenTable(Application, ParcelTable, 'parcelmasterfile',
...
begin
  ...
  If FindKeyOld(ParcelTable, ['SwisCode', 'SBL'],
                [SwisCode, SBL])
    then
      begin
        Result := True;
  ...
  If FindKeyOld(ParcelTable, ['SwisCode', 'SBL'],
    ...
    then
      with ParcelTable do
        try
          Edit;
          FieldByName('Owner').Text := NewNameAddressArray[1];
          FieldByName('MailAddr1').Text := NewNameAddressArray[2];
          FieldByName('MailAddr2').Text := NewNameAddressArray[3];
          FieldByName('MailAddr3').Text := NewNameAddressArray[4];
          FieldByName('MailAddr4').Text := NewNameAddressArray[5];
          FieldByName('MailAddr5').Text := NewNameAddressArray[6];
          Post;
        except
