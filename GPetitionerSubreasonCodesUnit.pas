unit GPetitionerSubreasonCodesUnit;
...
uses
  ...
  wwdblook, ComCtrls, wwriched, wwrichedspell;

type
  TPetitionerComplaintSubreasonCodeForm = class(TForm)
    ...
    MainTable: TwwTable;
    Label1: TLabel;
    ComplaintCategoryLookupCombo: TwwDBLookupCombo;
    ComplaintReasonCategoryTable: TwwTable;
    Label11: TLabel;
    SubreasonDescriptionDBRichEdit: TwwDBRichEditMSWord;
...
const
  CodeName = 'complaint reason code';
  CodeFieldName = 'Code';

{========================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.FormActivate(Sender: TObject);
...
{========================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.InitializeForm;
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.FormKeyPress(    Sender: TObject;
                                                var Key: Char);
...
{============================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.MainTableBeforePost(DataSet: TDataSet);
...
{===========================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.MainTableAfterPost(DataSet: TDataSet);
...
{===========================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.InsertButtonClick(Sender: TObject);
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.SaveButtonClick(Sender: TObject);
...
{===================================================================}
procedure TPetitionerComplaintSubreasonCodeForm.DeleteButtonClick(Sender: TObject);
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.UndoButtonClick(Sender: TObject);
...
{==========================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.PrintButtonClick(Sender: TObject);
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.ReportPrintHeader(Sender: TObject);
...
begin
  with Sender as TBaseReport do
    begin
      ...
      SetTab(5.1, pjCenter, 1.5, 0, BOXLINEBOTTOM, 0);   {Category}
      ...
      SetTab(5.1, pjLeft, 1.5, 0, BOXLINENone, 0);   {Category}
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.ReportPrint(Sender: TObject);
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.FormCloseQuery(    Sender: TObject;
...
{===================================================================}
Procedure TPetitionerComplaintSubreasonCodeForm.FormClose(    Sender: TObject;
