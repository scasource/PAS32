...
uses
  ...
  Mask, ExtCtrls, StdCtrls, DBCtrls;

type
  TSalesEntryDialogForm = class(TForm)
    ...
    Label2: TLabel;
    Label3: TLabel;
    SaleInformationGroupBox: TGroupBox;
    ...
    DueDate: TEdit;
    TimeOfSaleInformationGroupBox: TGroupBox;
...
var
  SalesEntryDialogForm: TSalesEntryDialogForm;
...
{=========================================================================}
Procedure TSalesEntryDialogForm.Load;
...
{=========================================================================}
Function TSalesEntryDialogForm.MeetsRequirements : Boolean;
...
{=========================================================================}
Function TSalesEntryDialogForm.Save : Boolean;
...
{=========================================================================}
Procedure TSalesEntryDialogForm.EditChange(Sender: TObject);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.ButtonsStateTimerTimer(Sender: TObject);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.SetReadOnlyFields;
...
{=========================================================================}
Procedure TSalesEntryDialogForm.InitializeForm(_SwisSBLKey : String;
                                               _NoteNumber : Integer;
                                               _EditMode : String);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.FormKeyPress(    Sender: TObject;
                                             var Key: Char);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.DueDateExit(Sender: TObject);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.SaveAndExitButtonClick(Sender: TObject);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.SaveButtonClick(Sender: TObject);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.CancelButtonClick(Sender: TObject);
...
{=========================================================================}
Procedure TSalesEntryDialogForm.FormCloseQuery(    Sender: TObject;
