...
type
  TGeneralizedComparisonReportForm = class(TForm)
    Panel1: TPanel;
    TitleLabel: TLabel;
...
{========================================================}
Procedure TGeneralizedComparisonReportForm.FormActivate(Sender: TObject);
...
{========================================================}
Procedure TGeneralizedComparisonReportForm.FillListBoxes;
...
{========================================================}
Procedure TGeneralizedComparisonReportForm.InitializeForm;
...
{===================================================================}
Procedure TGeneralizedComparisonReportForm.FormKeyPress(    Sender: TObject;
                                     var Key: Char);
...
{==============================================================}
Procedure TGeneralizedComparisonReportForm.ScreenListBoxClick(Sender: TObject);
...
{==============================================================}
Function TGeneralizedComparisonReportForm.RecordMeetsCriteria(ParcelTable : TTable;
                                                              AssessmentYear : String) : Boolean;
...
{==============================================================}
Function TGeneralizedComparisonReportForm.ValuesDifferent(    SwisSBLKey : String;
                                                          var Field1Value : String;
                                                          var Field2Value : String) : Boolean;
...
{==============================================================}
Procedure TGeneralizedComparisonReportForm.FillSortFile(var Cancelled : Boolean);
...
{==============================================================}
Procedure TGeneralizedComparisonReportForm.PrintButtonClick(Sender: TObject);
...
{==============================================================}
Procedure TGeneralizedComparisonReportForm.ReportPrintHeader(Sender: TObject);
...
{==============================================================}
Procedure TGeneralizedComparisonReportForm.ReportPrint(Sender: TObject);
...
{===================================================================}
Procedure TGeneralizedComparisonReportForm.FormClose(    Sender: TObject;
